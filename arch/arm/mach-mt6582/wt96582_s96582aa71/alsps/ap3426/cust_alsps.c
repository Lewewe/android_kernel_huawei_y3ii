...
static struct alsps_hw cust_alsps_hw = {
    ...
    .als_level  = { 10, 45, 200, 400, 700, 1200, 1500, 1800, 2200, 2699, 5000, 7622, 12000, 15000, 20000},
    .als_value  = { 0, 40, 90, 110, 160, 200, 250,  350,  550, 800, 1160, 3100,  5000,  8500, 10050, 10240},
    .ps_threshold_high = 592,
    .ps_threshold_low = 372,
};
