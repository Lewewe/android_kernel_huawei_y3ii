...
u32 pinSet[2][8] = {
	...
	if (On) {
		...
		} else if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI545_MIPI_RAW_BILU,currSensorName)))||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_HI545_MIPI_RAW,currSensorName)))) {
			if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_D2, VOL_1800,mode_name))
			{
				PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
				goto _kdCISModulePowerOn_exit_;
