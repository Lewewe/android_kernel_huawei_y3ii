...
extern int AW2028_led_set(unsigned char r, unsigned char g, unsigned char b, unsigned int ton_ms, unsigned int toff_ms);
...
{	
	mt_set_gpio_mode(GPIO_ENT, GPIO_CAMERA_FLASH_MODE_PIN_M_GPIO);
	mt_set_gpio_dir(GPIO_ENT, GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_ENT, GPIO_OUT_ZERO);
	mt_set_gpio_mode(GPIO_ENF, GPIO_CAMERA_FLASH_EN_PIN_M_GPIO);
...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	{"red",               MT65XX_LED_MODE_CUST, (int)AW2028_led_set,{0}},
	{"green",            MT65XX_LED_MODE_CUST, (int)AW2028_led_set,{0}},
	{"blue",              MT65XX_LED_MODE_CUST, (int)AW2028_led_set,{0}},
