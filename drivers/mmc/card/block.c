...
static const struct mmc_fixup blk_fixups[] =
{
  ...
  /* Hynix 16nm eMMC 5.0 discard GC state set incorrectly*/
  MMC_FIXUP(CID_NAME_ANY, CID_MANFID_HYNIX, CID_OEMID_ANY, add_quirk_mmc, MMC_QUIRK_DISABLE_DISCARD),//added by MTK to disable discard
