...
typedef enum
{	
    DSI_INCELL_IDLE_MODE,
    DSI_INCELL_SUSPEND_MODE,
    DSI_INCELL_GPIO_TIMER_MODE,
    DSI_INCELL_MIX_MODE,
    DSI_INCELL_GPIO_TIMER_MODE_FROM_MIX,
    DSI_INCELL_SEND_FRAME,
    DSI_INCELL_MIX_THREAD_MODE
} DSI_STATUS_FOR_MIX_MODE;
#endif
