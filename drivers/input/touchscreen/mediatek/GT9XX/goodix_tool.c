...
static  const struct file_operations  proc_goodix_file_fops = 
{
...
s32 init_wr_node(struct i2c_client *client)
{
    ...
    //goodix_proc_entry = proc_mkdir(GOODIX_ENTRY_NAME, NULL);
    goodix_proc_entry = proc_create( GOODIX_ENTRY_NAME, 666, NULL,&proc_goodix_file_fops);
