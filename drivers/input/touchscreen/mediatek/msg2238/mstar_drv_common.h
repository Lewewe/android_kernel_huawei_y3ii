...
#define MAX_I2C_TRANSACTION_LENGTH_LIMIT      (1000) // Please change the value depends on the I2C transaction limitation for the platform that you are using.
 ...
 * By default, this flag is enabled.
 */
#define CONFIG_ENABLE_TOUCH_DRIVER_DEBUG_LOG (0)   // 1 : Enable, 0 : Disable
