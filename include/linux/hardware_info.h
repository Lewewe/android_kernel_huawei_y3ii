...
#endif
#define HARDWARE_BATTERY_GET  _IOWR(HARDWARE_ID, 0x19, char[HARDWARE_MAX_ITEM_LONGTH])
#define HARDWARE_SPEAKER_PA_GET  _IOWR(HARDWARE_ID, 0x20, char[HARDWARE_MAX_ITEM_LONGTH])
